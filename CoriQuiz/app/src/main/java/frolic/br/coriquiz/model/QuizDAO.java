...
public class QuizDAO extends QuizDBHelper {
    ...
    public void addDefaultValues(){
        ...
        this.addQuestion(q7);
        Question q8=new Question("O Timão venceu o São Paulo na Libertadores na Libertadores de 2015 por qual placar na Arena Corinthians?","2 a 0","2 a 1","5 a 0","7 a 1", "NDA", 1);
        this.addQuestion(q8);
